...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 2501)"
    class="shadow-lg rounded-lg bg-white mx-auto m-8 p-4 notification-box flex fixed right-5 bottom-2">
    <div class="pr-2">
        {{--
